    ...
    <section className="relative w-full overflow-hidden bg-[#0B1739] py-16 sm:py-24 md:py-28">
      ...
      <div className="relative z-20 mx-auto flex max-w-7xl flex-col items-center px-4 sm:px-6 md:px-8 text-center">
        ...
        <div className="mt-10 sm:mt-14 grid w-full max-w-6xl grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          <GlassCard className="group relative overflow-hidden p-5 sm:p-6 text-left hover:border-sky-400/60">
          ...
          {/* Stat 2: 50+ Clients */}
          <GlassCard className="group relative overflow-hidden p-5 sm:p-6 text-left hover:border-blue-400/60">
          ...
          <GlassCard className="group relative overflow-hidden p-5 sm:p-6 text-left hover:border-purple-400/60">
          ...
          {/* Stat 4: 100+ Web Apps */}
          <GlassCard className="group relative overflow-hidden p-5 sm:p-6 text-left hover:border-indigo-400/60">
